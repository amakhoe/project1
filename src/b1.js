    ...
    return (
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div class="mb-14 text-center">
                  <h2 class="text-gradient text-4xl text-center font-bold  leading-[3.25rem] mb-6 max-w-max lg:max-w-3xl lg:mx-auto">Developed from scratch for seamless online functionality</h2>
                  <p class="text-base font-normal  lg:max-w-2xl lg:mx-auto mb-8 text-white">Using technology to make finance simpler, smarter and more rewarding. </p>  
